                ...
                for (var i = 0; i<data.length; i++)
                    {
                        ...
                        // ====================
                        $('#articles').append('<p>Click on Article Title to add a Comment!</p><p data-id="' + data[i]._id + '">'+ data[i].title + '<br />'+ data[i].link + '</p>');
                    }
            }
        );
    })
        ...
        .done(function(data)
            {
                ...
                // ==========
                $('#notes').append('<h6>' + data.title + '</h6><br><p>Leave a comment:</p>');
